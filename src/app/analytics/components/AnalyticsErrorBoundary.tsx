 ...
 * Catches and handles errors in analytics components
 */
          ...
          <div className="max-w-md w-full">
            <div className="bg-card border border-red-500/20 rounded-lg p-6 text-center">
              ...
              <p className="text-sm text-muted-foreground font-sans mb-4">
                An error occurred while loading the analytics. This might be due to invalid data or a temporary issue.
              </p>
