			...
			<>
				...
				>
					...
					<div className="absolute inset-0 opacity-20 pointer-events-none">
						<div
							className="absolute top-0 -left-1/4 w-1/2 h-1/2 bg-linear-to-br from-primary/10 to-transparent rounded-full blur-2xl animate-pulse"
							style={{
						...
						/>
						<div
							className="absolute bottom-0 -right-1/4 w-1/2 h-1/2 bg-linear-to-tl from-accent/10 to-transparent rounded-full blur-2xl animate-pulse"
							style={{
